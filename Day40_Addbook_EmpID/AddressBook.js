...
{
    try{
        let contact = new AddressBook("PremSagar", "Chottu", "Gaya", "Patna", "Bihar", "800331", "9812365425", "chottu@gmail.com");
    }catch (error) {
        console.error(error);
    }
}   

{
    ...
    AddressBookArray.push(new AddressBook("Deepak", "Kumar", "Dandibag", "Gaya", "Bihar", "800332", "9868686854", "deepak@gmail.com"));
    AddressBookArray.push(new AddressBook("Aryan", "Kumar", "Dandibag", "Gaya", "Bihar", "800332", "9868686854", "aryan@gmail.com"));
    AddressBookArray.push(new AddressBook("Sagar", "Kumar", "Dandibag", "Gaya", "Bihar", "800332", "9868686854", "sagar@gmail.com"));
    ...
    //DuplicateEntry
    {
        let newContact = new AddressBook("Aryan", "Kumar", "Dandibag", "Gaya", "Bihar", "800332", "9868686854", "aryan@gmail.com") ;
    ...
    {
        let givenCity = 'Gaya';
        let searchPersonInCityOrState = AddressBookArray.filter(contact => contact.firstName == 'Deepak' && contact.city == givenCity );
